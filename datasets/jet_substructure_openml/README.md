## NeuraLUT-Assemble on the jet substructure tagging dataset (OpenML)

This folder provides the code and resources to reproduce our NeuraLUT-Assemble results on the OpenML jet substructure tagging dataset.
...
```
python train.py --arch jsc-openml --log_dir demo --cuda --device 1
```
...
```
python neq2lut.py --arch jsc-openml \
